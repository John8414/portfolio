  ...
  return (
    <div className='flex flex-col gap-8'>
      ...
      <div className='block xl:hidden'>
        ...
        <p className='xl:text-2xl text-xl'>Frontend Developer</p>
      </div>
      <div className='flex flex-col gap-2'>
        <h2 className='text-blue-regular xl:text-2xl text-xl pb-4 uppercase'>About Me</h2>
      ...
      <div className='flex flex-col gap-2'>
        <h2 className='text-blue-regular xl:text-2xl text-xl pb-4 uppercase'>Contact Me</h2>
        <p><span>Phone:</span> (+84) 7777 08 457</p>
        <p><span>Email:</span> jmnguyen276@gmail.com</p>
        <p><span>Location:</span> Ho Chi Minh city</p>
      </div>
      <div className='flex flex-col gap-2'>
        <h2 className='text-blue-regular xl:text-2xl text-xl pb-4 uppercase'>Language</h2>
        <p><span>English</span> Upper-Intermediate</p>
        <p><span>Vietnamese</span> Native</p>
      </div>
      <div className='flex flex-col gap-2'>
        <h2 className='text-blue-regular xl:text-2xl text-xl pb-4 uppercase'>EDUCATION</h2>
        <p>Bachelor&apos;s Degree in
          Business Management
          at Hanoi Open University</p>
      </div>
      <div className='flex flex-col gap-2'>
        <h2 className='text-blue-regular xl:text-2xl text-xl pb-4 uppercase'>CERTIFICATE</h2>
